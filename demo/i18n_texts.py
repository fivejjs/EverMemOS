...
class I18nTexts:
    ...
    TEXTS: Dict[str, Dict[str, str]] = {
        ...
        "response_reasoning_label": {
            "zh": "🔍 推理过程",
            "en": "🔍 Reasoning"
        },
        "response_metadata_label": {
            "zh": "📊 元数据",
            "en": "📊 Metadata"
        },
        "response_notes_label": {
            "zh": "💡 补充说明",
            "en": "💡 Additional Notes"
        },
        "response_confidence": {
        ...
        "response_no_references": {
            "zh": "无",
            "en": "None"
        },
        "response_assistant_title": {
            "zh": "🤖 Assistant",
            "en": "🤖 Assistant"
        },
...
Schema:
{
  ...
  "additional_notes": "Optional supplementary notes or suggestions"
        ...
        "prompt_memory_subject": {
            "zh": "主题：{subject}",
            "en": "Topic: {subject}"
        },
        "prompt_memory_content": {
            "zh": "内容：{content}",
            "en": "Content: {content}"
        },
