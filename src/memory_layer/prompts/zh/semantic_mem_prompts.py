...
def get_group_semantic_generation_prompt(memcell_summary: str, memcell_episode: str, user_ids: list = None) -> str:
    """
    生成群组语义记忆联想预测的提示词
...
def get_semantic_generation_prompt(episode_summary: str, episode_content: str, user_id: str = None) -> str:
    """
    生成个人语义记忆联想预测的提示词
