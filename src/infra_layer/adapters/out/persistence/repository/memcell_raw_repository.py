...
class MemCellRawRepository(BaseRepository[MemCell]):
    ...
    async def append_memcell(self, memcell: MemCell, session: Optional[AsyncIOMotorClientSession] = None) -> Optional[MemCell]:
        """
        追加 MemCell
        """
        try:
    ...
    async def update_by_event_id(self, event_id: str, update_data: Dict[str, Any], session: Optional[AsyncIOMotorClientSession] = None) -> Optional[MemCell]:
        """
    ...
    async def delete_by_event_id(self, event_id: str, session: Optional[AsyncIOMotorClientSession] = None) -> bool:
        """
    ...
    async def find_by_user_id(
        ...
        try:
            ...
            logger.debug("✅ 根据用户 ID 查询 MemCell 成功: %s, 找到 %d 条记录", user_id, len(results))
            return results
        except Exception as e:
    ...
    async def find_by_user_and_time_range(
        ...
        try:
            ...
            results = await query.to_list()
            logger.debug("✅ 根据用户和时间范围查询 MemCell 成功: %s, 时间范围: %s - %s, 找到 %d 条记录", user_id, start_time, end_time, len(results))
            return results
        except Exception as e:
    ...
    async def find_by_group_id(
        ...
        try:
            ...
            results = await query.to_list()
            logger.debug("✅ 根据群组 ID 查询 MemCell 成功: %s, 找到 %d 条记录", group_id, len(results))
            return results
        except Exception as e:
    ...
    async def find_by_time_range(
        ...
        try:
            ...
            results = await query.to_list()
            logger.debug("✅ 根据时间范围查询 MemCell 成功: 时间范围: %s - %s, 找到 %d 条记录", 
                        start_time, end_time, len(results))
            return results
        except Exception as e:
    ...
    async def find_by_participants(
        ...
        try:
            ...
            results = await query.to_list()
            logger.debug("✅ 根据参与者查询 MemCell 成功: %s, 匹配模式: %s, 找到 %d 条记录", participants, '全部' if match_all else '任一', len(results))
            return results
        except Exception as e:
    ...
    async def search_by_keywords(
        ...
        try:
            ...
            results = await query.to_list()
            logger.debug("✅ 根据关键词查询 MemCell 成功: %s, 匹配模式: %s, 找到 %d 条记录", keywords, '全部' if match_all else '任一', len(results))
            return results
        except Exception as e:
    ...
    async def delete_by_user_id(self, user_id: str, session: Optional[AsyncIOMotorClientSession] = None) -> int:
        """
        删除用户的所有 MemCell
        ...
        try:
            ...
            logger.info("✅ 删除用户所有 MemCell 成功: %s, 删除 %d 条记录", user_id, count)
            return count
        except Exception as e:
    ...
    async def delete_by_time_range(
        ...
        try:
            ...
            count = result.deleted_count if result else 0
            logger.info("✅ 删除时间范围内 MemCell 成功: %s - %s, 用户: %s, 删除 %d 条记录", start_time, end_time, user_id or '全部', count)
            return count
        except Exception as e:
    ...
    async def count_by_user_id(self, user_id: str) -> int:
        ...
        try:
            ...
            logger.debug("✅ 统计用户 MemCell 数量成功: %s, 共 %d 条记录", user_id, count)
            return count
        except Exception as e:
    ...
    async def count_by_time_range(
        ...
        try:
            ...
            logger.debug("✅ 统计时间范围内 MemCell 数量成功: %s - %s, 用户: %s, 共 %d 条记录", start_time, end_time, user_id or '全部', count)
            return count
        except Exception as e:
    ...
    async def get_latest_by_user(self, user_id: str, limit: int = 10) -> List[MemCell]:
        ...
        try:
            ...
            logger.debug("✅ 获取用户最新 MemCell 成功: %s, 返回 %d 条记录", user_id, len(results))
            return results
        except Exception as e:
    ...
    async def get_user_activity_summary(
        ...
        try:
            ...
            logger.debug("✅ 获取用户活动摘要成功: %s, 总计 %d 条记录", user_id, total_count)
            return summary
        except Exception as e:
