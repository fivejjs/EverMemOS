...
class EpisodicMemoryRawRepository(BaseRepository[EpisodicMemory]):
    ...
    async def get_by_event_id(
        ...
        try:
            ...
            if result:
                ...
                logger.debug("ℹ️  未找到情景记忆: event_id=%s, user_id=%s", event_id, user_id)
            return result
    ...
    async def get_by_user_id(
        ...
        try:
            ...
            logger.debug("✅ 根据用户ID获取情景记忆成功: %s, 找到 %d 条记录", user_id, len(results))
            return results
        except Exception as e:
    ...
    async def append_episodic_memory(
        ...
        try:
            ...
            logger.info("✅ 追加情景记忆成功: event_id=%s, user_id=%s", 
                       episodic_memory.event_id, episodic_memory.user_id)
    ...
    async def delete_by_event_id(
        ...
        try:
            ...
            if success:
                ...
                logger.warning("⚠️  未找到要删除的情景记忆: event_id=%s, user_id=%s", event_id, user_id)
                return False
        except Exception as e:
    ...
    async def delete_by_user_id(
        ...
        try:
            ...
            logger.info("✅ 根据用户ID删除情景记忆成功: %s, 删除 %d 条记录", user_id, count)
            return count
        except Exception as e:
    ...
    async def find_by_time_range(
        ...
        try:
            ...
            results = await query.to_list()
            logger.debug("✅ 根据时间范围查询 EpisodicMemory 成功: 时间范围: %s - %s, 找到 %d 条记录", 
