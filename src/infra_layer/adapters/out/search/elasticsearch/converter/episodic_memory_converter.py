...
from infra_layer.adapters.out.persistence.document.memory.episodic_memory import EpisodicMemory as MongoEpisodicMemory
    ...
    def from_mongo(cls, source_doc: MongoEpisodicMemory) -> EpisodicMemoryDoc:
        ...
        try:
            ...
            es_doc = EpisodicMemoryDoc(
                ...
                # 核心内容字段
                title=getattr(source_doc, 'subject', None),  # MongoDB的subject映射到ES的title
    ...
    def from_memory(cls, episode_memory: EpisodeMemory) -> EpisodicMemoryDoc:
        ...
        try:
            ...
            es_doc = EpisodicMemoryDoc(
                ...
                # 核心内容字段
                title=getattr(episode_memory, 'subject', None),  # Memory的subject映射到ES的title
