...
def compute_accuracy_from_judgments(file_path):
    ...
    return accuracies, mean_accuracy, std_dev_accuracy, category_accuracies, category_correct, category_total
...
if __name__ == "__main__":
    ...
    try:
        accuracies, mean_acc, std_dev_acc, category_accs, category_correct, category_total = compute_accuracy_from_judgments(results_file_path)
